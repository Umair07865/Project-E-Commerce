...
function appendingindashboardd()
{
let appendinglast={};

//fetching the data of the products
fetch('https://dummyjson.com/products?_start=20&_limit=10')
.then((response)=>{
...
let mappeddata="";
  ...
  appendinglast.products.map(function(elem,index){
   ...
   <ul>
    ...
    document.getAnimations("section2").innerHTML="none";
